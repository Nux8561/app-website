...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background via-background to-accent/10">
      {/* Animated background */}
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          >
            {siteConfig.product} revolutioniert die Gesprächsvorbereitung im B2B-Vertrieb.
            Deep Research, automatisiert – damit Sie sich auf das Wesentliche konzentrieren können.
          </motion.p>
