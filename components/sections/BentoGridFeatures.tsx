...
export function BentoGridFeatures() {
  const features = [
    {
      title: "Deep Research in Sekunden",
      description:
        "Unsere KI analysiert öffentliche Datenquellen und erstellt umfassende Unternehmensprofile in unter 60 Sekunden.",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 border-b md:col-span-4 md:border-r lg:col-span-4 dark:border-neutral-800",
    },
    {
      title: "KI-gestützte Insights",
      description:
        "Modernste KI-Technologie liefert präzise Informationen zu Entscheidern, Tech-Stack und aktuellen Projekten.",
      skeleton: <SkeletonTwo />,
      className:
        "col-span-1 border-b md:col-span-2 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Erfolgsgeschichten ansehen",
      description:
        "Erfahren Sie, wie andere Unternehmen ihre Abschlussquote mit IntroGroup verdoppelt haben.",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 border-b md:col-span-3 md:border-r lg:col-span-3 dark:border-neutral-800",
    },
    {
      title: "Global verfügbar",
      description:
        "Unsere Cloud-Infrastruktur ermöglicht blitzschnelle Performance weltweit – DSGVO-konform in der EU gehostet.",
    ...
    <div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-40">
      <div className="px-8">
        <h4 className="mx-auto max-w-5xl text-center text-3xl font-medium tracking-tight text-black dark:text-white lg:text-5xl lg:leading-tight">
          Alles, was Sie für erfolgreiche Gespräche brauchen
        </h4>

        <p className="mx-auto my-4 max-w-2xl text-center text-sm font-normal text-neutral-500 dark:text-neutral-300 lg:text-base">
          Von automatisierter Recherche bis zur HubSpot-Integration – IntroGroup bietet
          alle Tools für modernen B2B-Vertrieb.
        </p>
      </div>

      <div className="relative">
        <div className="mt-12 grid grid-cols-1 rounded-md md:grid-cols-6 lg:grid-cols-6 xl:border dark:border-neutral-800">
...
export const SkeletonThree = () => {
  return (
    <Link
      href="https://www.linkedin.com/company/intro-group-germany/"
      target="_blank"
...
export const SkeletonTwo = () => {
  const images = [
    "https://images.unsplash.com/photo-1517322048670-4fba75cbbb62?w=400&h=400&fit=crop",
    "https://images.unsplash.com/photo-1573790387438-4da905039392?w=400&h=400&fit=crop",
    "https://images.unsplash.com/photo-1555400038-63f5ba517a47?w=400&h=400&fit=crop",
    "https://images.unsplash.com/photo-1554931670-4ebfabf6e7a9?w=400&h=400&fit=crop",
    "https://images.unsplash.com/photo-1546484475-7f7bd55792da?w=400&h=400&fit=crop",
  ];
